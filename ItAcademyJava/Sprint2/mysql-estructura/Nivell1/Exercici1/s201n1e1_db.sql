...
CREATE TABLE IF NOT EXISTS `s201n1e1_relational_model`.`sale_invoices` (
  `id_sale_invoice` INT(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `s201n1e1_relational_model`.`glasses` (
  `id_glasses` INT(10) NOT NULL AUTO_INCREMENT,
  `provider_id` INT(5) NOT NULL,
  `sale_invoice_id` INT(10) NULL,
...
CREATE TABLE IF NOT EXISTS `s201n1e1_relational_model`.`provider_catalogues` (
  `id_catalogue` INT(10) NOT NULL AUTO_INCREMENT,
  `brand_id` INT(10) NULL,
  `provider_id` INT(5) NULL,
