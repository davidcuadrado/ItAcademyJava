...
class CalculoDniTest {
	...
	private static Stream<Arguments> dniPredefinits() {
		return Stream.of(Arguments.of(345864985, 'P'), Arguments.of(45926775, 'J'), Arguments.of(34865971, 'L'),
				Arguments.of(61248537, 'R'), Arguments.of(35694528, 'T'), Arguments.of(84532699, 'N'),
				Arguments.of(75426485, 'K'), Arguments.of(326458521, 'V'), Arguments.of(32654851, 'S'),
