...
public class NotifyStockObserver implements StockObserver {
	...
	public void update(String eventType, Stock stockEntity) {
		System.out.println("Alert sent to " + observerDirection +
				": stock value on " + stockEntity.getName() +" has changed and a new value has been setted to: " + stockEntity.getValue() + " due " + eventType + " operation performed ");
	}
